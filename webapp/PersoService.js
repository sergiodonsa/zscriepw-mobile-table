sap.ui.define(['jquery.sap.global'],
	...
	var DemoPersoService = {
		...
		oData : {
			...
			aColumns : [
				{
					id: "zscriepw-productsTable-productCol",
					order: 2,
					text: "Product",
					visible: true
				},
				{
					id: "zscriepw-productsTable-supplierCol",
					order: 1,
					text: "Supplier",
					visible: true
				},
				{
					id: "zscriepw-productsTable-dimensionsCol",
					order: 0,
					text: "Dimensions",
					visible: false
				},
				{
					id: "zscriepw-productsTable-weightCol",
					order: 3,
					text: "Weight",
					visible: true
				},
				{
					id: "zscriepw-productsTable-priceCol",
					order: 4,
					text: "Price",
					visible: true
				}
